...
let skills = ["HTML 5", "CSS 3", "JS", "Angular", "Node", "Express"];
...
for(i = 0; i< skills.length; i++){
	result += `<li class="alert alert-primary" role="alert">${skills[i]}</li>`;
}
			...
			<div class="card text-center" >
				<div>
					<div class="card-header">
						<h5><i class="fa-solid fa-id-badge"></i>  ${postsArr[i].title}</h5>
					</div>
					<div class="card-body">
						<p class="card-text">${postsArr[i].body}</p>
					</div>
